				...
				<li>
					...
					<div class="tab-item-thumbnail">
						<a href="<?php echo get_permalink($recent["ID"]); ?>" title="<?php echo $recent["post_title"]; ?>">
							<?php
								$thumbnail = get_the_post_thumbnail( $recent["ID"], 'thumb-small', array( ) );
							?>
							<?php if ( $thumbnail ) {
								echo $thumbnail;
							} else { ?>
								<img src="<?php echo get_template_directory_uri(); ?>/img/thumb-small.png" alt="<?php echo $recent["post_title"]; ?>" />
							<?php } ?>
